...
export function GroceryPage() {
  ...
  const [preDragOrder, setPreDragOrder] = useState<Record<
    string,
    string[]
  > | null>(null);
  ...
  function handleDragOver({ active, over }: DragOverEvent) {
    ...
    const overContainer =
      itemOrder[overId] !== undefined ? overId : findContainer(overId);
  ...
  function handleDragEnd({ active, over }: DragEndEvent) {
    ...
    if (!over) {
      ...
      dragOriginStore &&
      currentContainer &&
      dragOriginStore !== currentContainer
    ) {
      ...
      if (overContainer === currentContainer) {
        setItemOrder((prev) => {
          ...
          return {
            ...prev,
            [currentContainer]: arrayMove(ids, oldIdx, newIdx),
          };
        });
      }
    }
