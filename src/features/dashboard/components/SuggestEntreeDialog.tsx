...
import { useMealHistory, useAddMealSuggestion } from '@/features/meals/hooks/useMeals'
...
export function SuggestEntreeDialog({ meal, open, onOpenChange }: SuggestEntreeDialogProps) {
