...
export function UpdatePrompt() {
  ...
  // Triggers the SW update and reloads as a fallback in case
  // controllerchange doesn't fire (common on desktop Chrome/Safari).
  const triggerUpdate = () => {
  ...
  return (
    <button
      ...
      className="fixed top-0 left-0 right-0 z-100 flex w-full items-center justify-center gap-2.5 bg-primary px-4 pb-3 pt-[calc(0.75rem+env(safe-area-inset-top))] text-sm font-medium text-primary-foreground shadow-md transition-opacity hover:opacity-90 active:opacity-80"
      aria-live="assertive"
